=== Gallery by Ape with slideshow, slider, lightbox, carousel ===
Contributors: galleryape
Donate link: http://wpape.net
Tags: gallery, photo gallery, image gallery, slider, slideshow, carousel, responsive gallery, wordpress gallery, lightbox, gallery grid, masonry gallery, thumbnails
...
*   [Filmstrip carousel demo](https://wpape.net/demo/filmstrip-carousel/)
...
*   [Vertical 3d slider demo](https://wpape.net/demo/vertical-3d-slider/)
*   [Wall style demo with push down effect](http://wpape.net/demo/wall-wordpress-gallery-push-down-effect/)
*   [Fade image slideshow demo](https://wpape.net/demo/fade-image-slideshow/)
*   [Polaroid style with icons and HTML in description](http://wpape.net/demo/polaroid-wordpress-gallery-icons-description/)
*   [Horizontal image slider demo](https://wpape.net/demo/horizontal-image-slider/)
*   [Demo without spacing between thumbnails and push up effect](http://wpape.net/demo/wordpress-gallery-wall-push-up-effect/)
*   [Images carousel demo](https://wpape.net/demo/images-carousel/)
*   [Demo in red colors with border, top menu and red zoom button](http://wpape.net/demo/red-menu-wordpress-gallery-custom-styles/)
*   [Flip slider demo](https://wpape.net/demo/flip-slider/)
*   [Demo in green style with categories on top, zoom button and title](http://wpape.net/demo/wordpress-gallery-green-categories/)
*   [Vertical image slider demo](https://wpape.net/demo/vertical-image-slider/)
...
*   [Horizontal 3d slider demo](https://wpape.net/demo/horizontal-3d-slider/)
*   [Custom thumbnails grid layout demo with black borders](http://wpape.net/demo/grid-layout-wordpress-gallery-black-border/)
*   [Vertical carousel demo](https://wpape.net/demo/vertical-carousel/)
...
1. polaroid style thumbnails.
2. filmstrip carousel
3. demo with circle thumbnails.
4. image slider with 3d cube effect
5. images carousel
6. vertical image slider
7. grid layout demo.
8. cars demo.
9. thumbnails without spacing.
10. mix of thumbnails with description panel.
11. classic  layout, right menu alignment.
12. green demo.
13. masonry layout.
14. without top menu.
15. thumbnails settings.
16. interface settings.
17. description settings.
18. menu settings.
19. menu styles.
...
= How to select image animation effect ? =
...
= Where to select image slider animation effect? =
...
= Which direction of the hover animation possible to use in slider? =

In current version possible to select vertical or horizontal direction of the slider animation.

= Which pagination modes available in slider? =
